...
def test_copy_directory():
    porter.copy(dir2, dir1, ignore=True)
    porter.copy(dir2, dir1, force=True)
...
def test_move_directory():
    porter.move(os.path.join(dir1, 'dir2'), dir2, ignore=True)
    porter.move(os.path.join(dir1, 'dir2'), dir2, force=True)
    porter.move_to(os.path.join(dir1, 'dir2'), test_porter, ignore=True)
